...
| Method                                                               | Description                                          |
| -------------------------------------------------------------------- | ---------------------------------------------------- |
| [`collection.load`](/api-reference/python/tilebox.datasets/Collection.load) |  Query data points from a collection.                 |
| [`collection.find`](/api-reference/python/tilebox.datasets/Collection.find) | Find a specific datapoint in a collection by its id. |
...
If you know the ID of the data point you want to load, you can use [collection.find](/api-reference/python/tilebox.datasets/Collection.find).
