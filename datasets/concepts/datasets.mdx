...
| Method                                                               | Description                                          |
| -------------------------------------------------------------------- | ---------------------------------------------------- |
| [`client.datasets`](/api-reference/python/tilebox.datasets/Client.datasets) |  List all available datasets.                        |
| [`client.dataset`](/api-reference/python/tilebox.datasets/Client.dataset) | Access an individual dataset by its name.              |
...
For example, the *code name* for the Sentinel-2 MSI dataset, which is part of the `open_data.copernicus` group, the code name is `open_data.copernicus.sentinel2_msi`.
