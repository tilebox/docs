...
export const cookbookSections = [
  {
    ...
    guides: [
      ...
      },
      {
        ...
        description: "Combine three public Sentinel-2 COG assets into a cloud-free RGB image.",
        icon: "magnifying-glass-location",
        level: "Beginner",
        time: "10 min",
        tags: ["Assets", "COG", "Sentinel-2", "RGB"],
      },
      {
        title: "Create a Sentinel-1 radar image",
        href: "/guides/datasets/access-sentinel1-data",
        description: "Render a north-up monochrome image from a public Sentinel-1 GRD measurement COG.",
        icon: "radar",
        level: "Intermediate",
        time: "15 min",
        tags: ["Assets", "COG", "Sentinel-1", "SAR"],
      },
      {
