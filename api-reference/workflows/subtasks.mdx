...
To submit [subtasks](/workflows/tasks#subtasks-and-task-composition) from a task, you can use the `submit_subtask`
...
<ParamField path="task" type="Task">
  An optional [cluster slug](/workflows/clusters#managing-clusters) to run the subtask on. If not provided, the subtask
