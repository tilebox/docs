...
Submit multiple subtasks to the runner. Same as [SubmitSubtask](/api-reference/go/workflows/SubmitSubtask), but accepts a list of tasks.
...
<ParamField path="WithClusterSlug(clusterSlug string)" default="cluster of the runner">
