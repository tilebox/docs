...
If not defined, the task can't be registered with a runner but can still be submitted.
...
If not defined, the runner will generate an identifier for it using reflection.
