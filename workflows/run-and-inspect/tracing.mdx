...
See [Query telemetry](/workflows/run-and-inspect/query-telemetry) for the log and span query APIs.

## Export to another backend

Tilebox stores traces by default. To export spans to your own observability backend as well, configure an [OpenTelemetry](/workflows/run-and-inspect/integrations/open-telemetry) or [Axiom](/workflows/run-and-inspect/integrations/axiom) integration when the runner process starts.
