...
Tilebox stores logs by default. To export logs to your own observability backend as well, configure an [OpenTelemetry](/workflows/run-and-inspect/integrations/open-telemetry) or [Axiom](/workflows/run-and-inspect/integrations/axiom) integration when the runner process starts.
