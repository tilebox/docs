---
title: Automations
sidebarTitle: Trigger jobs automatically
...
for _, automation := range automations {
    slog.InfoContext(ctx,
        "automation",
        slog.String("id", automation.ID.String()),
        slog.String("name", automation.Name),
        slog.Int("cron_triggers", len(automation.CronTriggers)),
        slog.Int("storage_event_triggers", len(automation.StorageEventTriggers)),
    )
}
```
</CodeGroup>
