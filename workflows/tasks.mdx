...
<Frame>
    <img src="/assets/workflows/diagrams/svg/download-dog-images.svg" alt="Download Dog Images Workflow" className="dark:hidden"/>
    <img src="/assets/workflows/diagrams/svg/download-dog-images.dark.svg" alt="Download Dog Images Workflow" className="hidden dark:block" />
</Frame>
...
<Frame>
    <img src="/assets/workflows/diagrams/svg/download-dog-images-recursive.svg" alt="Download Dog Images Workflow implemented recursively" className="dark:hidden"/>
    <img src="/assets/workflows/diagrams/svg/download-dog-images-recursive.dark.svg" alt="Download Dog Images Workflow implemented recursively" className="hidden dark:block" />
</Frame>
...
<Frame>
    ...
    <img src="/assets/workflows/diagrams/svg/process-news.dark.svg" alt="Process News Workflow" className="hidden dark:block" />
</Frame>
