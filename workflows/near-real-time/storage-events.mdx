...
Storage Event Tasks are recurring tasks triggered when objects are created or modified in a [storage location](#storage-locations).
...
storage_event_automation = automations.create_storage_event_automation(
    "log-object-creations",  # name of the recurring storage event automation
