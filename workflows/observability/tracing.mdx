...
<Frame>
  <img src="/assets/workflows/observability/workflow-traces-light.png" alt="Tilebox Workflows tracing in Axiom" className="dark:hidden" />
  <img src="/assets/workflows/observability/workflow-traces-dark.png" alt="Tilebox Workflows tracing in Axiom" className="hidden dark:block" />
</Frame>
