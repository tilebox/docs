...
<Update label="August 27, 2026">
    ...
    <Frame>
    <img src="/assets/changelog/2026-08-27-dashboard.png" alt="Tilebox Console Dashboard Page" />
    </Frame>
    ...
    <Columns cols={1}>
      <Card title="Open the Console Dashboard" icon="gauge-high" href="https://console.tilebox.com/home" horizontal>
...
<Update label="August 26, 2026">
    ...
    <Frame>
    <img src="/assets/changelog/2026-08-26-sentinel1-cloud-reveal.gif" alt="Cloud-covered Sentinel-2 optical imagery of Venice transitioning to Sentinel-1 radar imagery captured on the same day" />
    </Frame>
