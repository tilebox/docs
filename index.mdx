...
<div className="px-6 py-16 bg-gray-50 dark:bg-zinc-950 border-y border-gray-200 dark:border-zinc-800">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="mt-8">
      <Columns cols={2}>
        <Tile href="/datasets/query/querying-data" title="Query satellite data" description="Search typed datasets by time, location, collection, custom fields, or datapoint ID.">
    ...
    <div className="mt-8">
      <Columns cols={3}>
        ...
        <Card title="Assets and storage" icon="folder-open" href="/datasets/assets-and-storage/overview" horizontal />
