  ...
  <div className="max-w-6xl mx-auto grid lg:grid-cols-12 gap-12 items-start">
    <div className="lg:col-span-5">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <a className="inline-flex items-center gap-2 rounded-lg border border-gray-200 dark:border-gray-800 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:hover:border-gray-700 hover:text-gray-950 dark:hover:text-white" href="/guides/datasets/ingest-into-spatiotemporal-catalog">
          <Icon icon="database" />
          Ingest data
        </a>
      </div>
    ...
    <div className="lg:col-span-7">
      ...
      Build a reproducible workflow that starts with a user-provided CSV
      of known data centers and then:
      ...
      Use the provided Tilebox skills to research datasets, access storage, outline the
      workflow, and then implement it. Deploy and run on our GCP cluster, in case of
      failures inspect runner logs and iterate on the workflow.
      ```
      ...
      <div className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mt-8 space-y-4">
            ...
            <a className="flex items-center gap-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-950 dark:hover:text-white" href="/agents-and-ai-tools/tilebox-mcp">
              <Icon icon="plug" />
              Connect with MCP
            </a>
          </div>
