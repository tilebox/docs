...
datasetsClient := datasets.NewClient(
...
<Tip>
In Python, if you set your API key as an environment variable named `TILEBOX_API_KEY`, you can skip the token parameter when creating a client.
</Tip>
