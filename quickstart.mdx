...
<Tab title="Python">
  <Steps>
    ...
    <Step title="Create an API key">
      Create an API key by logging into the [Tilebox Console](https://console.tilebox.com), heading to [Account -> API Keys](https://console.tilebox.com/account/api-keys) and clicking on the "Create API Key" button.
