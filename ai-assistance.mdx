...
It requires authentication via OAuth. When connecting, you'll be redirected to sign in with your Tilebox account and select a team to authorize the MCP server for.
